...
var ServiceCenterService = (function () {
    function ServiceCenterService(http, navParams) {
        this.http = http;
        this.navParams = navParams;
        console.log('Hello loginService Provider');
    }
    ServiceCenterService.prototype.getServiceInfo = function () {
        return this.http.get(constants_1.APP_SERVE_URL + '/user/getKfInfo.api?partnerId=888')
            .map(function (res) {
    ...
    ServiceCenterService.prototype.handleError = function (error) {
        var errMsg;
